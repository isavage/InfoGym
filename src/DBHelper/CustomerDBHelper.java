...
public class CustomerDBHelper {
    ...
    public void saveCustomer(Customer customer) {
        ...
        query = "insert into customer(first_name,last_name,address,tel_no,mobile_no,date_of_birth,date_of_joining) "
                + "values('&firstname','&lastname','&address','&tel_no','&mobile_no','&dob','&doj');";
